...
<div class="Card">
  ...
  <div class="Card-container">
    <div class="Card-Header">
      <div class="Card-user">
        <img src="https://arepa.s3.amazonaws.com/elmo002.jpg" alt="falta">
        <h2>
          User002.pgb
    ...
    <div class="Card-photo">
      <figure on:dblclick={handleLike}>
        <img src="https://arepa.s3.amazonaws.com/elmo002.jpg">
      </figure>
    </div>
    <div class="Card-icons">
      <div class="Card-icons-first">
        <i class="fas fa-star" class:active-like={like} on:click={handleLike}/>
